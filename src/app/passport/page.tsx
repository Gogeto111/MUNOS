          ...
          <div className="grid gap-4 lg:grid-cols-2">
            <Card>
              ...
              <CardContent className="space-y-3">
                {awards.length === 0 ? (
                  <p className="py-6 text-center text-sm text-muted-foreground">No awards yet. They&apos;ll appear here as you earn them.</p>
                ) : (
                  awards.map((item) => (
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                {certificates.length === 0 ? (
                  <p className="py-6 text-center text-sm text-muted-foreground">No certificates yet. They&apos;ll appear here once issued.</p>
                ) : (
    ...
    return (
      <div className="flex min-h-[50vh] flex-col items-center justify-center text-center">
        ...
        <Button asChild className="mt-4" variant="outline">
          <Link href="/passport">Reload</Link>
        </Button>
      </div>
    );
  }
